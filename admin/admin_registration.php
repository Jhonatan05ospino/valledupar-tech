...
<body>
    ...
    <div class="landing admin-register">
        <div class="">
            <h2 class="text-center mb-1">Inicio de sesion de Administrador</h2>
                ...
                <div class="col-md-6 py-4 px-5 d-flex flex-column gap-4">
                    <div>
                        <form action="" method="post" class="d-flex flex-column gap-4" enctype="multipart/form-data">
                            ...
                            <div class="form-outline">
                                <label for="admin_image" class="form-label">Imagen de administrador</label>
                            ...
                            <div class="form-outline">
                                ...
                                <p class="small">
                                    Ya tienes una cuenta? <a href="./admin_login.php" class="text-decoration-underline text-success fw-bold">Ingresar</a>
                                </p>
                            </div>
                        </form>
                    </div>
