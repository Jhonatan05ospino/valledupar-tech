    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column gap-3 mb-3">
                ...
                <div class="form-outline">
                    <label for="product_keywords" class="form-label">Palabras claves</label>
                ...
                <div class="form-outline">
                    <label for="product_brand" class="form-label">Categoria del producto</label>
                ...
                <div class="form-outline">
                    <label for="product_image_one" class="form-label">Imagen del producto 1</label>
                    <div class="d-flex">
                ...
                <div class="form-outline">
                    <label for="product_image_two" class="form-label">Imagen del producto 2</label>
                    <div class="d-flex">
                ...
                <div class="form-outline">
                    <label for="product_image_three" class="form-label">Imagen del producto 3</label>
                    <div class="d-flex">
