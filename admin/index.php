...
<body>
    ...
    <div class="upper-nav primary-bg p-2 px-3 text-center text-break">
        <span>Panel de administración y envío exprés gratuito</span>
    </div>
    <!-- upper-nav -->
    <!-- Start NavBar -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContentad">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Bienvenidos <?php echo $admin_name;?></a>
                    </li>
                    <li class="nav-item">
                    <button class="btn btn-primary p-0 px-1">
                            <a href="./admin_logout.php" class="nav-link text-light">Salir</a>
                        </button>
                    </li>
                </ul>
    ...
    <div class="control">
        <div class="container pt-4 pb-0">
            <div class="categ-header">
                ...
                <h2>Administrar detalles del comercio</h2>
            </div>
                ...
                <div class="col-md-10">
                    <div class="buttons">
                        <button class="btn btn-outline-primary m-2">
                            <a href="./insert_product.php" class="nav-link">Insertar producto</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?view_products" class="nav-link">Ver productos</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?insert_category" class="nav-link">Insertar Categoria</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?view_categories" class="nav-link">Ver Categorias</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
                            <a href="index.php?insert_brand" class="nav-link">Insertar marca</a>
                        </button>
                        <button class="btn btn-outline-primary m-2">
