...
<body>
    ...
    <div class="upper-nav primary-bg p-2 px-3 text-center text-break">
        <span>Entrega gratis para todas las compras de diciembre - OFF 50%! <a>Comprar Ahora</a></span>
    </div>
    <!-- upper-nav -->
    <!-- Start NavBar -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">AboutAcerca de nosotros</a>
                    </li>
                    <li class="nav-item">
                    <li class="nav-item">
                    <a class="nav-link" href="#">ontactanos</a>
                    </li>
                    <?php
        ...
        <div class="container">
            <div class="sub-container pt-4 pb-4">
                <div class="categ-header">
                    ...
                    <h2>Buscar por Categoria y Marca</h2>
                </div>
                <div class="row mx-0">
